...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<button data-id="btn-cancel" class="mui-btn mui-btn-blue mui-btn-outlined">取消</button>\
			<li class="date-tips">时间</li>\
			<button data-id="btn-ok" class="mui-btn mui-btn-red">确定</button>\
		</div>\
